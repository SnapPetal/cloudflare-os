...
import { Database, Hexagon, MagnifyingGlass, ShieldWarning, UserPlus } from '@phosphor-icons/react'
    ...
    <div className="mx-auto w-full max-w-[1040px] px-4 sm:px-8 py-8 space-y-6">
      ...
      <Tabs
        ...
        tabs={[
          ...
          { value: 'booking', label: 'Booking Operations' },
          { value: 'vectors', label: 'Skatetricks Knowledge' },
